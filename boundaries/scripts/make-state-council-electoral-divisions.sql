...
SELECT
	...
	CASE attribs.STATE_PID
		WHEN '1' THEN 'country:au/state:nsw/slced:' || lower(attribs.SE_PID)
		WHEN '2' THEN 'country:au/state:vic/slced:' || lower(attribs.SE_PID)
		WHEN '3' THEN 'country:au/state:qld/slced:' || lower(attribs.SE_PID)
		WHEN '4' THEN 'country:au/state:sa/slced:' || lower(attribs.SE_PID)
		WHEN '5' THEN 'country:au/state:wa/slced:' || lower(attribs.SE_PID)
		WHEN '6' THEN 'country:au/state:tas/slced:' || lower(attribs.SE_PID)
		WHEN '7' THEN 'country:au/state:nt/slced:' || lower(attribs.SE_PID)
		WHEN '8' THEN 'country:au/state:act/slced:' || lower(attribs.SE_PID)
		WHEN '9' THEN 'country:au/state:ot/slced:' || lower(attribs.SE_PID)
	END AS MS_FB,
